var dataTranslate = {
	...
	'about__menu-resume': ['Резюме', 'Resume'],
	'about__menu-portfolio': ['Портфолио', 'Portfolio'],
	...
	'aspirations__hobbies-description': 
		...
		'<p>In&nbsp;a&nbsp;free time&nbsp;I like to&nbsp;play in&nbsp;voleyball, ride a&nbsp;bike around town, play on&nbsp;guitar and find out something about scientific discoveries.</p>'],
	...
	'description__list__frontend-text': 
		...
		'<p>Adaptive layout of&nbsp;templates, bug fixes on&nbsp;a&nbsp;prodaction. If&nbsp;necessary, I&nbsp;can make in&nbsp;pixel pirfect.</p>'],
	...
	'description__list__seo-text': 
		...
		'<p>Understanding the principles of&nbsp;SEO. <br>For example, if&nbsp;we&nbsp;are writing a&nbsp;web application on&nbsp;React and we&nbsp;have a&nbsp;page 404 in&nbsp;routs, the question that&nbsp;I will have&nbsp;is: what response code will return application if&nbsp;we&nbsp;deleted the page that was existed earlier? By&nbsp;the rules of&nbsp;good tone, it&nbsp;should return not 404 Not Found, but 410&nbsp;Gone.</p>'],
	'description__list__git': ['Git', 'Git'],
	'description__list__git-text': 
		['<p>Что еще здесь добавить? Это must have. Использую Bitbucket и&nbsp;GitHub</p>', 
	...
	'skills__description': 
		...
		'<p>Below presented a&nbsp;list of&nbsp;technologies what i&nbsp;work with. I&nbsp;do not pretend to&nbsp;be&nbsp;a&nbsp;broad-profile specialist, but one of&nbsp;my&nbsp;strong qualities is&nbsp;curiosity. I&rsquo;m interested in&nbsp;everything a&nbsp;little bit, but&nbsp;I want to&nbsp;be&nbsp;a&nbsp;professional in&nbsp;one thing. In&nbsp;frontend development.</p>' +
		'<p>Besides presented technologies i&nbsp;superficially deal with Ajax, testing with Chai/Mocha, Linux (Ubuntu, Kali), ReactJS + Redax + Routing. In&nbsp;perspective i&nbsp;want fully master&nbsp;it.</p>'],
	'skills__btn-cta': ['Связаться со&nbsp;мной', 'Contact&nbsp;me'],
	'resume__h2': ['Резюме', 'Resume'],
	'resume__description': 
		['<p>Кстати! Чуть не&nbsp;забыл. Вы&nbsp;можете так&nbsp;же скачать для удобства rtf версию резюме.</p>', 
		'<p>By&nbsp;the way! I&nbsp;almost forgot. You can also download the rtf version of&nbsp;the resume for your convenience</p>'],
	...
	'education__description': 
		...
		'<p>Так&nbsp;же 2&nbsp;года подряд был участником &laquo;Группы Личностного Роста&raquo;. На&nbsp;группе понравились такие темы:</p>' +
		'<ul>' +
		'<li>&mdash;&nbsp;Понятие зрелости и&nbsp;инфантильности.</li>' +
		'<li>&mdash;&nbsp;6&nbsp;ступеней развития личности.</li>' +
		'<li>&mdash;&nbsp;Аналитическое мышление.</li>' +
		'<li>&mdash;&nbsp;Как управлять своими мыслями, чувствами и&nbsp;внутренним миром.</li>' +
		...
		'<ul>' +
		'<li>&mdash;&nbsp;The concept of&nbsp;maturity and infantilism.</li>' +
		'<li>&mdash;&nbsp;6&nbsp;steps of&nbsp;personality development.</li>' +
		'<li>&mdash;&nbsp;Analytical thinking.</li>' +
		'<li>&mdash;&nbsp;How to&nbsp;manage your thoughts, feelings and inner peace.</li>' +
	...
	'institution__nau__description':
		...
		'<p>I&nbsp;wrote and successfully defended the qualification thesis work &laquo;specialist&raquo;. Theme of&nbsp;the thesis work: &laquo;The system of&nbsp;automatically recognising of&nbsp;the tempo of&nbsp;the audio signal&raquo;. This work describes a&nbsp;system, which using mathematical methods is&nbsp;able to&nbsp;determine the tempo of&nbsp;a&nbsp;musical fragment. The purpose of&nbsp;this work was the creation of&nbsp;software in&nbsp;the language of&nbsp;C#, which implemented the system, which is&nbsp;based on&nbsp;the algorithm presented at&nbsp;the Mirex conference in&nbsp;2006&nbsp;year. On&nbsp;this graduation paper&nbsp;I wrote an&nbsp;article in&nbsp;the scientific journal of&nbsp;the university, which was published in&nbsp;2012.</p>'],
	'institution__htmlAcademy': ['HTML Academy', 'HTML Academy'],
	'institution___htmlAcademy__period': ['2&nbsp;месяца', '2&nbsp;month'],
	'institution__htmlAcademy__description': 
		['<p>Данный курс помог мне ознакомиться с&nbsp;основами верстки.</p>', 
		'<p>This course helped me&nbsp;get to&nbsp;know the basics of&nbsp;HTML&nbsp;&amp; CSS codding.</p>'],
	'institution__phpAcademy': ['PHP Academy', 'PHP Academy'],
	'institution___phpAcademy__period': ['6&nbsp;месяцев', '6&nbsp;month'],
	'institution__phpAcademy__description': 
		['<p>На&nbsp;данном курсе я&nbsp;больше углубился во&nbsp;фронтенд, открыл для себя ReactJS и&nbsp;ES-6, изучил PHP и&nbsp;базы данных.</p>', 
		'<p>In&nbsp;this course, I&nbsp;went deeper into the frontend, I&nbsp;discovered ReactJS and ES-6, I&nbsp;studied PHP and databases.</p>'],
	'work__h2': ['Опыт работы', 'Work experience'],
	'work__description': 
	...
	'work__beryozin__description': 
		...
		'<li>Сбор семантического ядра и&nbsp;группировки по&nbsp;страницам</li>' +
		'<li>Проводил работы по&nbsp;внутренней оптимизации сайта (настройка редиректов, текстовая оптимизация, перелинковка)</li>' +
		'<li>Работал с&nbsp;сервисами Serpstat, Ahrefs</li>' +
		'<li>Составление ТЗ&nbsp;копирайтеру, верстальщику, программисту</li>' +
		'<li>Подключал сервисы аналитики и&nbsp;метрики, регистрировал в&nbsp;каталогах (Dmoz, Яндекс.Каталог), социальных сетях, Google Maps и&nbsp;Яндекс Картах.</li>' +
		'<li>Составление предложений по&nbsp;повышению удобства пользования сайтом</li>' +
		'</ul>', 
		'<p>Worked as&nbsp;an&nbsp;Junior SEO specialist. My&nbsp;duties included:</p>' +
		'<ul class="content-list">' +
		'<li>Made a&nbsp;semantic core and grouping by&nbsp;pages</li>' +
		'<li>Creating site structure</li>' +
		'<li>Worked on&nbsp;internal optimization (setting up&nbsp;redirects, text optimization, links)</li>' +
		'<li>Worked Serpstat and Ahrefs services</li>' +
		'<li>Making up&nbsp;task order request for copywriter, layout designer, programmer</li>' +
		'<li>I&nbsp;connected analytics and metrics services, registered in&nbsp;directories (Dmoz, Yandex.Catalog), social networks, Google Maps and Yandex Maps.</li>' +
		'<li>Making up&nbsp;proposition for increase the usability of&nbsp;the site</li>' +
		'</ul>'],
	...
	'work__seostudio__description': 
		...
		'<ul class="content-list">' +
		'<li>Составление стратегий развития проектов</li>' +
		'<li>Подробный аудит на&nbsp;выявление технических ошибок и&nbsp;составление&nbsp;ТЗ на&nbsp;их&nbsp;исправление</li>' +
		'<li>Поиск и&nbsp;устранение дублирующегося контента, аффилиатов сайта</li>' +
		'<li>Создание структуры сайта</li>' +
		'<li>Ведение ссылочных компаний</li>' +
		'<li>Продвижение проектов под Россию, Украину, Казахстан</li>' +
		'<li>Вел 10-15 проектов одновременно</li>' +
		'</ul>', 
		'<p>Worked as&nbsp;an&nbsp;SEO specialist. My&nbsp;duties included:</p>' +
		'<ul class="content-list">' +
		'<li>Making up&nbsp;strategies for the evolution of&nbsp;projects</li>' +
		'<li>Detailed audit o&nbsp;identify technical errors and compile task order request for their correction</li>' +
		'<li>Searching and elimination of&nbsp;duplicated content, duplicated site-affiliates</li>' +
		'<li>Management of&nbsp;links companies</li>' +
		'<li>Promotion of&nbsp;projects for Russia, Ukraine, Kazakhstan</li>' +
		'<li>Led 10-15 projects simultaneously</li>' +
		'</ul>'],
	...
	'work__agromat__description': 
		...
		'<ul class="content-list">' +
		'<li>Исправление багов в&nbsp;верстке</li>' +
		'<li>Верстка отдельных компонентов на&nbsp;страницах</li>' +
		'</ul>' +
		...
		'<ul class="content-list">' +
		'<li>Correcting bugs in&nbsp;layout</li>' +
		'<li>Coding of&nbsp;individual components on&nbsp;the pages</li>' +
		'</ul>' +
	...
	'work__ukrvet__description': 
		...
		'<ul class="content-list">' +
		'<li>Курировал переезд сайта с&nbsp;платформы prom.ua на&nbsp;платформу horoshop.com.ua</li>' +
		'<li>Создание лендинга для нового направления товаров</li>' +
		'<li>Постановка и&nbsp;контроль выполнения задач, помощь членам команды в&nbsp;профессиональном росте</li>' +
		'</ul>', 
		'<p>Worked as&nbsp;a&nbsp;head of&nbsp;content department. My&nbsp;duties included:</p>' +
		'<ul class="content-list">' +
		'<li>Supervised the relocation of&nbsp;the site from the prom.ua platform to&nbsp;the horoshop.com.ua platform</li>' +
		'<li>Creating a&nbsp;landing for a&nbsp;new direction of&nbsp;goods</li>' +
		'<li>Delegation and control of&nbsp;tasks, assistance to&nbsp;team members in&nbsp;professional growth</li>' +
		'</ul>'],
	'philosophy__h2': ['Несколько философских мыслей', 'Several philosophical thoughts'],
	'philosophy__description': 
	['... от&nbsp;людей, у&nbsp;которых мне повезло учиться в&nbsp;университете, работе, жизни.', 
	'... from people, from whom&nbsp;I was fortunate to&nbsp;study at&nbsp;university, work, life.'],
	'citation-1': 
	['<p>Голова&nbsp;&mdash; это не&nbsp;мусорный ящик. Не&nbsp;нужно в&nbsp;ней хранить что попало.</p>Старший преподаватель высшей математики, Погребецкая Т.А.', 
	'<p>The head is&nbsp;not a&nbsp;garbage can. You do&nbsp;not need to&nbsp;store heap of&nbsp;everything in&nbsp;it.</p>Senior teacher of&nbsp;higher mathematics, Pogrebetskaya Т.А.'],
	'citation-2': 
	['<p>Инженер&nbsp;&mdash; это не&nbsp;тот, кто все знает и&nbsp;умеет, а&nbsp;тот, кто знает где найти и&nbsp;как этим воспользоваться.</p>Профессор кафедры АКИК, Аблесимов&nbsp;А.&nbsp;К.', 
	'<p>The engineer is&nbsp;not the one who knows and can everything, but the one who knows where to&nbsp;find and how to&nbsp;use&nbsp;it.</p>Professor of&nbsp;the chair AKIK, Ablesimov A.K.'],
	'citation-3': 
	['<p>Ищи мотивацию.</p>Доцент и&nbsp;преподаватель микросхемотехники, Мартынюк В.С.', 
	'<p>Seek motivation.</p>Associate professor and teacher of&nbsp;microcircuitry, Martyniuk V.S.'],
	'citation-4': 
	['<p>Трудности рождают прорыв.</p>Пастор церкви Слово Благодати, Белоножко А.А', 
	'<p>Difficulties give birth to&nbsp;a&nbsp;breakthrough.</p>Pastor of&nbsp;the Church Word of&nbsp;Grace, Belonozhko A.A.'],
	'citation-5': 
	['<p>Если какой-то пункт в&nbsp;формулировке&nbsp;ТЗ может быть истолкован исполнителем неправильно, значит со 100% вероятностью он именно так и будет истолкован.</p>Senior SEO специалист', 
	'<p>If&nbsp;any item in&nbsp;the formulation of&nbsp;task order request can be&nbsp;interpreted incorrectly by&nbsp;the executor, then with 100% probability it&nbsp;will be&nbsp;just so&nbsp;interpreted.</p>Senior SEO specialist'],
	'portfolio__h2': ['Портфолио','Portfolio'],
	...
	'form__btn-contact': ['Отправить', 'Send'],
	'copyright':['Сверстано с&nbsp;любовью&nbsp;&mdash; 2017', 'Codding with Love&nbsp;&mdash; 2017'],
};