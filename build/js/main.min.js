...
inpt_subm.addEventListener('click',function(event){isValide?send(e):showError('Проверьте корректность данных','Check the correctness of the entered data');});function send(e){e.prevetnDefault();var xhr=new XMLHttpRequest();var form=document.forms.contactForm;var formData=new FormData(form);xhr.open('POST','mailer.php',true);xhr.send(formData);}
